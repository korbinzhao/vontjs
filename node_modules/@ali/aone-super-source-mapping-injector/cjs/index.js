...
var _traverse = /*#__PURE__*/ _interop_require_wildcard._(require("@babel/traverse"));
var _generator = /*#__PURE__*/ _interop_require_wildcard._(require("@babel/generator"));
var _types = /*#__PURE__*/ _interop_require_wildcard._(require("@babel/types"));
var _traverseModule_default, _generateModule_default;
// 提取实际的函数，兼容不同环境
var traverse = ((_traverseModule_default = _traverse.default) === null || _traverseModule_default === void 0 ? void 0 : _traverseModule_default.default) || _traverse.default || _traverse;
var generate = ((_generateModule_default = _generator.default) === null || _generateModule_default === void 0 ? void 0 : _generateModule_default.default) || _generator.default || _generator;
// 默认配置
var DEFAULT_OPTIONS = {
    enabled: true,
...
function getSourceMappingInfo(fileName, lineNumber) {
    ...
    var config = _object_spread._({}, DEFAULT_OPTIONS, options);
    return {
        file: fileName,
        line: lineNumber,
        column: columnNumber,
            ...
            JSXElement: function JSXElement(path) {
                try {
                    ...
                    var hasSourceMapping = openingElement.attributes.some(function(attr) {
                        return _types.isJSXAttribute(attr) && _types.isJSXIdentifier(attr.name) && attr.name.name === "data-source-file";
                    });
                    if (hasSourceMapping) {
                        return;
                    }
                    ...
                    var sourceMappingAttrs = [
                        _types.jsxAttribute(_types.jSXIdentifier("data-source-file"), _types.stringLiteral(sourceInfo.file)),
                        _types.jsxAttribute(_types.jSXIdentifier("data-source-line"), _types.stringLiteral(sourceInfo.line.toString())),
                        _types.jsxAttribute(_types.jSXIdentifier("data-source-component"), _types.stringLiteral(sourceInfo.component))
                    ];
                    (_openingElement_attributes = openingElement.attributes).push.apply(_openingElement_attributes, _to_consumable_array._(sourceMappingAttrs));
                } catch (elementError) {
...
var SourceMappingInjector = /*#__PURE__*/ function() {
    ...
    function SourceMappingInjector() {
        var options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        _class_call_check._(this, SourceMappingInjector);
        _define_property._(this, "options", void 0);
        this.options = _object_spread._({}, DEFAULT_OPTIONS, options);
    }
    _create_class._(SourceMappingInjector, [
        {
            // 转换代码
            key: "transform",
